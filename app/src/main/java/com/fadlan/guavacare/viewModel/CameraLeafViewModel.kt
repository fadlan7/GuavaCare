...
class CameraLeafViewModel : ViewModel() {

    companion object {
        private val TAG = CameraLeafViewModel::class.java.simpleName
    }
    private lateinit var classifier: LeafClassification
    ...
    fun setDetectionPicture(image: Image, context: Context) {
        classifier = LeafClassification(context)
